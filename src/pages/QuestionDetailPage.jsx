    ...
    <div className="mx-auto max-w-2xl space-y-4 pb-4">
      ...
      <div className="space-y-4 rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <span className="rounded-lg bg-indigo-50 px-3 py-1 text-xs font-medium text-indigo-600">{question.subject}</span>
        ...
        <div className="space-y-2 rounded-xl border border-rose-200 bg-rose-50 p-4">
          ...
          <p className="text-sm leading-relaxed text-rose-800">当前归类为 <span className="font-semibold">{question.errorReason}</span>。</p>
        </div>

        <div className="space-y-2 rounded-xl border border-emerald-200 bg-emerald-50 p-4">
          <div className="flex items-center gap-2">
            <div className="h-1.5 w-1.5 rounded-full bg-emerald-500" />
            <span className="text-sm font-semibold text-emerald-900">老师 / 系统备注</span>
          </div>
          <p className="whitespace-pre-line text-sm leading-relaxed text-emerald-800">{question.notes}</p>
        </div>
      </div>
